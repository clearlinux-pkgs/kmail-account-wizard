...
%setup -q -n kmail-account-wizard-25.04.1
cd %{_builddir}/kmail-account-wizard-25.04.1
pushd ..
cp -a kmail-account-wizard-25.04.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747181955
mkdir -p clr-build
pushd clr-build
