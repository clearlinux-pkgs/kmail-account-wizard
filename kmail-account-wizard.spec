...
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/kmail-account-wizard-21.12.0.tar.xz
...
%prep
%setup -q -n kmail-account-wizard-21.12.0
cd %{_builddir}/kmail-account-wizard-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639684430
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmail-account-wizard-21.12.0/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/kmail-account-wizard/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/kmail-account-wizard-21.12.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kmail-account-wizard/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/kmail-account-wizard-21.12.0/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/kmail-account-wizard/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/kmail-account-wizard-21.12.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kmail-account-wizard/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
