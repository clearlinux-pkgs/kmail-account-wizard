...
Version  : 24.12.2
Release  : 116
URL      : https://download.kde.org/stable/release-service/24.12.2/src/kmail-account-wizard-24.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/kmail-account-wizard-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/kmail-account-wizard-24.12.2.tar.xz.sig
...
%setup -q -n kmail-account-wizard-24.12.2
cd %{_builddir}/kmail-account-wizard-24.12.2
pushd ..
cp -a kmail-account-wizard-24.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739159182
mkdir -p clr-build
pushd clr-build
