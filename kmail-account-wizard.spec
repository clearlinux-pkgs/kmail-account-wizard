...
Version  : 23.08.5
Release  : 82
URL      : https://download.kde.org/stable/release-service/23.08.5/src/kmail-account-wizard-23.08.5.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.5/src/kmail-account-wizard-23.08.5.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.5/src/kmail-account-wizard-23.08.5.tar.xz.sig
...
%prep
%setup -q -n kmail-account-wizard-23.08.5
cd %{_builddir}/kmail-account-wizard-23.08.5
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708423828
mkdir -p clr-build
pushd clr-build
