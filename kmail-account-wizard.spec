...
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/kmail-account-wizard-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/kmail-account-wizard-22.12.1.tar.xz.sig
...
%prep
%setup -q -n kmail-account-wizard-22.12.1
cd %{_builddir}/kmail-account-wizard-22.12.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673385820
mkdir -p clr-build
pushd clr-build
