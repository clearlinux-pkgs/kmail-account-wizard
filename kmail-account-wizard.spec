...
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/kmail-account-wizard-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/kmail-account-wizard-23.08.2.tar.xz.sig
...
%prep
%setup -q -n kmail-account-wizard-23.08.2
cd %{_builddir}/kmail-account-wizard-23.08.2
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697405372
mkdir -p clr-build
pushd clr-build
