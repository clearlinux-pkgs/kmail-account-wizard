...
Version  : 20.12.3
Release  : 30
URL      : https://download.kde.org/stable/release-service/20.12.3/src/kmail-account-wizard-20.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.12.3/src/kmail-account-wizard-20.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.3/src/kmail-account-wizard-20.12.3.tar.xz.sig
...
%prep
%setup -q -n kmail-account-wizard-20.12.3
cd %{_builddir}/kmail-account-wizard-20.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618684345
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmail-account-wizard-20.12.3/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/kmail-account-wizard/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/kmail-account-wizard-20.12.3/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kmail-account-wizard/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
